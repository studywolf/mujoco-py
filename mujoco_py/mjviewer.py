...
class MjViewer(MjViewerBasic):
    ...
    def _create_full_overlay(self):
        ...
        if not self.use_controller:
            ...
            self.add_overlay(const.GRID_TOPLEFT, "Exit", "[Esc]")
            ...
            self.add_overlay(const.GRID_TOPLEFT, "Toggle adaptation", "[Xbox]")
            ...
            self.add_overlay(const.GRID_TOPLEFT, "Restart", "[B]")
            self.add_overlay(const.GRID_TOPLEFT, "Exit", "[Back]")
